...
@router.put("/{party_id}", name="party_detail_save_form_partial", response_class=HTMLResponse)
...
@router.get("/{party_id}/edit", name="partial_party_detail_edit", response_class=HTMLResponse)
